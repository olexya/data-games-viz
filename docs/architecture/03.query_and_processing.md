...
|------|-------------|---------------|-------|-------|--------------|--------------|-----------------|------|
| AmphiETL | Batch Processing | N/A | 858 | 37 | 2 | 20/03/2024 | Yes | https://github.com/amphi-ai/amphi-etl |
| Apache Beam | Batch Processing | 20/02/2016 | 6.9k | 4.2k | 1270 | 15/06/2024 | Yes | https://github.com/apache/beam |
| Apache Spark | Batch Processing | 26/03/2010 | 38.8k | 28.1K | 2094 | 10/06/2024 | Yes | https://github.com/apache/spark |
| Dask | Batch Processing | 07/01/2015 | 12.2k | 1.7k | 570 | 10/07/2024 | Yes | https://github.com/dask/dask |
| dbt | Batch Processing | 09/02/2016 | 9.2k | 1.5k | 305 | 26/06/2024 | Yes | https://github.com/dbt-labs/dbt-core |
| Ibis Project | Batch Processing | N/A | 5.2k | 592 | 177 | 11/09/2024 | Yes | https://github.com/ibis-project/ibis |
| Pandas | Batch Processing | 03/03/2010 | 42.5k | 17.5k | 3232 | 10/04/2024 | Yes | https://github.com/pandas-dev/pandas |
| Polars | Batch Processing | 23/10/2020 | 29k | 1.8k | 181 | 28/08/2024 | Yes | https://github.com/pola-rs/polars |

### Stream Processing

| Tool | Subcategory | Creation Date | Stars | Forks | Contributors | Last Release | Meets Criteria* | Link |
|------|-------------|---------------|-------|-------|--------------|--------------|-----------------|------|
| Apache Flink | Stream Processing | 19/03/2014 | 23.4k | 13.1k | 1223 | 03/07/2024 | Yes | https://github.com/apache/flink |
| Apache Kafka | Stream Processing | 03/08/2011 | 27.7k | 13.6k | 1161 | 08/07/2024 | Yes | https://github.com/apache/kafka |
| Apache Samza | Stream Processing | 02/05/2013 | 916 | 540 | 99 | 15/03/2023 | Yes | https://github.com/apache/samza |
| Apache Storm | Stream Processing | 17/09/2011 | 6.7k | 4.2k | 265 | 17/01/2024 | Yes | https://github.com/apache/storm |
| Materialize | Stream Processing | 31/03/2019 | 5.2k | 301 | 125 | 28/06/2024 | Yes | https://github.com/MaterializeInc/materialize |
| Redpanda | Stream Processing | 12/11/2020 | 9.5k | 582 | 138 | 11/10/2024 | Yes | https://github.com/redpanda-data/redpanda |
...
2. **Apache Beam**: Unified programming model for batch and streaming data processing, offering language-specific SDKs for defining data processing workflows.
3. **Apache Spark**: Fast and general-purpose cluster computing system, providing high-level APIs in Java, Scala, Python and R, and an optimized engine.
4. **Dask**: Flexible library for parallel computing in Python, scaling Python and Pandas workflows efficiently.
5. **dbt**: Transforms data in warehouses by allowing analysts and engineers to define models using SQL SELECT statements.
6. **Ibis Project**: Expression compiler for analytics, bridging different query engines with a unified Python API for data analytics.
7. **Pandas**: Powerful Python data manipulation and analysis library, offering data structures for efficiently storing large datasets.
8. **Polars**: Fast multi-threaded DataFrame library for Rust and Python, designed as a faster alternative to Pandas.
...
3. **Apache Samza**: Distributed stream processing framework that uses Apache Kafka for messaging, and Hadoop YARN for fault tolerance and resource management.
...
6. **Redpanda**: Modern streaming platform compatible with Kafka API, built for mission-critical workloads with high performance and low latency.
...
3. **Apache Hive**: Data warehouse software facilitating reading, writing, and managing large datasets in distributed storage using SQL.
4. **Apache Impala**: Massively Parallel Processing (MPP) SQL query engine for data stored in Hadoop clusters.
5. **Apache Kylin**: Extreme OLAP engine for big data that allows for sub-second queries on datasets with trillions of rows.
6. **ClickHouse**: Open-source column-oriented database management system for real-time analytics using SQL.
7. **Datafusion**: Fast query engine for Apache Arrow, written in Rust.
8. **Doris**: High-performance real-time analytical database based on MPP architecture.
9. **Druid**: High performance real-time analytics database designed for workflows where fast queries and ingest really matter.
10. **DuckDB**: In-process SQL OLAP database management system, designed to be fast and efficient for analytical queries.
11. **GraphQL**: Query language for APIs and a runtime for executing those queries with existing data.
12. **Hydra**: Unified interface for constructing and executing complex analytical queries across different query engines and data sources.
13. **PostgreSQL**: Powerful, open source object-relational database system with a strong reputation for reliability and data integrity.
14. **Presto**: Distributed SQL query engine for big data, designed for fast analytic queries against data of any size.
15. **StarRocks**: High-performance analytical database that enables real-time, multi-dimensional, and highly concurrent data analysis.
16. **Trino**: Fast distributed SQL query engine for big data analytics, designed to efficiently query vast amounts of data.
